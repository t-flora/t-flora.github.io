Astro Cactus is a simple opinionated starter built with the Astro framework. I used to start a(nother) blog/website.
...
The Astro Cactus theme was inspired by [Hexo Theme Cactus](https://github.com/probberechts/hexo-theme-cactus)